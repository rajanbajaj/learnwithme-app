...
export default defineComponent({
  ...
  data: function() {
    ...
    return {
      posts,
      isLoading: true,
      fetch_url: 'http://localhost:3000/api/posts?status=PUBLIC,PUBLIC_RESTRICTED&limit=4',
      fetch_count_url: 'http://localhost:3000/api/posts/count?status=PUBLIC,PUBLIC_RESTRICTED',
      config: {
        headers: {
